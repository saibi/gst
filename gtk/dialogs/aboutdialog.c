...
void show_about(GtkWidget *widget, gpointer data)
{
	...
	gtk_about_dialog_set_copyright(GTK_ABOUT_DIALOG(dialog), "(c) saibi");
	gtk_about_dialog_set_comments(GTK_ABOUT_DIALOG(dialog), "Battery is a simple tool for battery checking.");
	gtk_about_dialog_set_website(GTK_ABOUT_DIALOG(dialog), "https://www.google.com/search?q=battery");
